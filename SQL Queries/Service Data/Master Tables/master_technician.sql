...
SELECT m.id
	...
	,CASE 
	WHEN m.Service_Market__c = mt.MSA_CSA__c
	THEN mt.MSA_CSA__c
	...
	WHEN q.Name = 'Howe, Will'
	THEN 'Boston-Cambridge -NH-VT-ME'
	WHEN q.Name = 'Campbell, Ed'
	THEN 'Boston-Cambridge -NH-VT-ME'
	WHEN q.Name = 'Negron, Waldy'
	THEN 'Manhattan, NY'
	WHEN m.[SVMXC__Role__c] LIKE '%Region%'
	THEN 'Quench Corporate'
	END as Market
	...
	,ISNULL(m.[SVMXC__Email__c], f.Email)  as 'Email'
	,CASE WHEN m.Name = 'Bailey, Dameond'
	THEN 'Hliwski, Steve'
