...
SELECT DISTINCT s.SVMXC__Order_Type__c
		...
		,CASE WHEN versionStartTime <= GETDATE()  AND VersionEndTime > GETDATE() AND SVMXC__Preferred_Start_Time__c <= GETDATE()
			THEN 1 ELSE NULL END as 'DateCheck0'

		,CASE WHEN versionStartTime <= EOMONTH(GETDATE(), -1)  AND VersionEndTime > EOMONTH(GETDATE(), -1) AND SVMXC__Preferred_Start_Time__c <= EOMONTH(GETDATE(), -1)
			THEN 1 ELSE NULL END as 'DateCheck1'
	
		,CASE WHEN versionStartTime <= EOMONTH(GETDATE(), -2)  AND VersionEndTime > EOMONTH(GETDATE(), -2) AND SVMXC__Preferred_Start_Time__c <= EOMONTH(GETDATE(), -2)
			THEN 1 ELSE NULL END as 'DateCheck2'

		,CASE WHEN versionStartTime <= EOMONTH(GETDATE(), -3)  AND VersionEndTime > EOMONTH(GETDATE(), -3) AND SVMXC__Preferred_Start_Time__c <= EOMONTH(GETDATE(), -3)
			THEN 1 ELSE NULL END as 'DateCheck3'

		,CASE WHEN versionStartTime <= EOMONTH(GETDATE(), -4)  AND VersionEndTime > EOMONTH(GETDATE(), -4) AND SVMXC__Preferred_Start_Time__c <= EOMONTH(GETDATE(), -4)
			THEN 1 ELSE NULL END as 'DateCheck4'

		,CASE WHEN versionStartTime <= EOMONTH(GETDATE(), -5)  AND VersionEndTime > EOMONTH(GETDATE(), -5) AND SVMXC__Preferred_Start_Time__c <= EOMONTH(GETDATE(), -5)
			THEN 1 ELSE NULL END as 'DateCheck5'
	
		,CASE WHEN versionStartTime <= EOMONTH(GETDATE(), -6)  AND VersionEndTime > EOMONTH(GETDATE(), -6) AND SVMXC__Preferred_Start_Time__c <= EOMONTH(GETDATE(), -6)
			THEN 1 ELSE NULL END as 'DateCheck6'

		,CASE WHEN versionStartTime <= EOMONTH(GETDATE(), -7)  AND VersionEndTime > EOMONTH(GETDATE(), -7) AND SVMXC__Preferred_Start_Time__c <= EOMONTH(GETDATE(), -7)
			THEN 1 ELSE NULL END as 'DateCheck7'

		,CASE WHEN versionStartTime <= EOMONTH(GETDATE(), -8)  AND VersionEndTime > EOMONTH(GETDATE(), -8) AND SVMXC__Preferred_Start_Time__c <= EOMONTH(GETDATE(), -8)
			THEN 1 ELSE NULL END as 'DateCheck8'

		,CASE WHEN versionStartTime <= EOMONTH(GETDATE(), -9)  AND VersionEndTime > EOMONTH(GETDATE(), -9) AND SVMXC__Preferred_Start_Time__c <= EOMONTH(GETDATE(), -9)
			THEN 1 ELSE NULL END as 'DateCheck9'
	
		,CASE WHEN versionStartTime <= EOMONTH(GETDATE(), -10)  AND VersionEndTime > EOMONTH(GETDATE(), -10) AND SVMXC__Preferred_Start_Time__c <= EOMONTH(GETDATE(), -10)
			THEN 1 ELSE NULL END as 'DateCheck10'

		,CASE WHEN versionStartTime <= EOMONTH(GETDATE(), -11)  AND VersionEndTime > EOMONTH(GETDATE(), -11) AND SVMXC__Preferred_Start_Time__c <= EOMONTH(GETDATE(), -11)
			THEN 1 ELSE NULL END as 'DateCheck11'

		,CASE WHEN versionStartTime <= EOMONTH(GETDATE(), -12)  AND VersionEndTime > EOMONTH(GETDATE(), -12) AND SVMXC__Preferred_Start_Time__c <= EOMONTH(GETDATE(), -12)
